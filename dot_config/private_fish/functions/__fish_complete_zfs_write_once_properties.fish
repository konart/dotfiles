function __fish_complete_zfs_write_once_properties --description 'Completes with ZFS properties which can only be written at filesystem creation, and only be read thereafter'
    set -l OS ""
    switch (uname)
        case Linux
            set OS Linux
