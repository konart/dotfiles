function __fish_print_gpg_algo --description 'Complete using all algorithms of the type specified in argv[2] supported by gpg. argv[2] is a regexp' --argument __fish_complete_gpg_command
